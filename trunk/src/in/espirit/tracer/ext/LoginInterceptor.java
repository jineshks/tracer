...
import in.espirit.tracer.action.RSSFeedActionBean;
...
public class LoginInterceptor implements Interceptor {
	...
	private static final List<Class<? extends BaseActionBean>> EXC = Arrays.asList(LoginActionBean.class, UserSignUpActionBean.class, RSSFeedActionBean.class);
