...
import in.espirit.tracer.action.RegisterActionBean;
...
public class LoginInterceptor implements Interceptor {
	...
	private static final List<Class<? extends BaseActionBean>> EXC = Arrays.asList(LoginActionBean.class, RegisterActionBean.class);
